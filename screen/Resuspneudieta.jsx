...
const Resuspneudieta = ({navigation}) => {
        ...
        <View style= { styles.logoContainer }>
          <View style={{paddingBottom:0 }}>
            <FlatList
              ...
              renderItem={({ item }) => {
                return (
                    <AppButton title={item.key} icon={item.number} iconBg="#e8c1cb" style={{fontSize: 15, fontWeight: 'regular'}} uppercase={false} borderBottom />
                );
              }}
            />
